            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">图书表列表</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('serial')">图书编号</th>
                                    <th onclick="sort('name')">图书名称</th>
                                    <th onclick="sort('author')">图书作者</th>
                                    <th onclick="sort('lbTypes')">图书类别</th>
                                    <th onclick="sort('cbsTypes')">图书出版社</th>
                                    <th onclick="sort('sjTypes')">所在书架</th>
                                    <th onclick="sort('sfTypes')">是否借阅</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function search() {
        ...
        if ($('#serialSearch').val() != null && $('serialSearch').val() != '') {
            searchForm.serial = $('#serialSearch').val();
    ...
    function setDataRow(item, number) {
        ...
        serialCell.innerHTML = item.serial;
        ...
        var detailAttr = "borrowBooks(" + item.id + ')';
        detailBtn.setAttribute("type", "button");
        detailBtn.setAttribute("class", "btn btn-info btn-sm 借书");
        detailBtn.setAttribute("onclick", detailAttr);
        detailBtn.innerHTML = "借书"
    ...
    // 删除
    function borrowBooks(id) {
        var mymessage = confirm("真的要借这本书吗？");
        if (mymessage == true) {
            paramArray = id;
            httpJson("tushu/borrowBooks", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("tushu/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "tushu");
